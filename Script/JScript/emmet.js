...
function Init() {
	...
	addMenuItem('Expand Abbreviation'   , menu_name, 'emmet_expandAbbreviation'  , 'Ctrl+Alt+Enter');
	addMenuItem('Wrap with Abbreviation', menu_name, 'emmet_wrapWithAbbreviation', 'Ctrl+Shift+Alt+Enter');
	addMenuItem('Balance Tag'           , menu_name, 'emmet_balanceTag'          , 'Alt+Shift+W');
	addMenuItem('Balance Tag Inward'    , menu_name, 'emmet_balanceTagInward'    , 'Alt+W');
	addMenuItem('Merge Lines'           , menu_name, 'emmet_mergeLines'          , 'Ctrl+Alt+J');
	addMenuItem('Next Edit Point'       , menu_name, 'emmet_nextEditPoint'       , 'Ctrl+.');
	addMenuItem('Previous Edit Point'   , menu_name, 'emmet_prevEditPoint'       , 'Ctrl+,');
	addMenuItem('Remove Tag'            , menu_name, 'emmet_removeTag'           , 'Ctrl+Alt+T');
	addMenuItem('Split/Join Tag'        , menu_name, 'emmet_splitJoinTag'        , 'Shift+Ctrl+Alt+T');
	addMenuItem('Toggle Comment'        , menu_name, 'emmet_toggleComment'       , 'Ctrl+Alt+;');
	
	// v0.7
	addMenuItem('Evaluate Math Expression', menu_name, 'emmet_evaluateMath' , 'Ctrl+Alt+E');
	addMenuItem('Increment number by 1'   , menu_name, 'emmet_incrementBy1' , 'Ctrl+Alt+Home');
	addMenuItem('Decrement number by 1'   , menu_name, 'emmet_decrementBy1' , 'Ctrl+Alt+End');
	addMenuItem('Increment number by 0.1' , menu_name, 'emmet_incrementBy01', 'Alt+Shift+Home');
	addMenuItem('Decrement number by 0.1' , menu_name, 'emmet_decrementBy01', 'Alt+Shift+End');
	addMenuItem('Increment number by 10'  , menu_name, 'emmet_incrementBy10', 'Ctrl+Shift+Alt+Home');
	addMenuItem('Decrement number by 10'  , menu_name, 'emmet_decrementBy10', 'Ctrl+Shift+Alt+End');
	
	addMenuItem('Select Next Item'    , menu_name, 'emmet_selectNextItem', 'Ctrl+Shift+.');
	addMenuItem('Select Previous Item', menu_name, 'emmet_selectPrevItem', 'Ctrl+Shift+,');
	addMenuItem('Reflect CSS Value'   , menu_name, 'emmet_reflectCSS'    , 'Ctrl+Alt+R');
}
