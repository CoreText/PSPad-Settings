var module_name='js_beautify';
var module_ver='1.0';

function Init()
{
  menuName = "&Format Code";
  addMenuItem("&JS Beautify from Einars", menuName, "js_Format", "ALT+SHIFT+F");
}
...
function js_Format() {
	...
	if( editor.selText().length>0 ) {
		editor.selText( js_beautify( editor.selText()) );
	}
	else {
		editor.Text( js_beautify( editor.Text() ) );
	}
}
